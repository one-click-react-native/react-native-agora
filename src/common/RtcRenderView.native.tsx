 ...
 * Properties of the TextureView.
 */
export interface RtcLocalTextureViewProps {
  /**
   * The rendering mode of the video view.
   */
  renderMode?: VideoRenderMode;
 ...
 * @ignore
 */
const RCTRtcLocalTextureView = requireNativeComponent<RtcRenderViewProps>(
  'RCTAgoraRtcLocalTextureView'
);

/**
 * @ignore
 */
export class RtcLocalTextureView extends Component<
  ViewProps & RtcLocalTextureViewProps & RtcUidProps,
  {}
> {
  render() {
    const { channelId, uid, ...others } = this.props;
    return <RCTRtcLocalTextureView data={{ channelId, uid }} {...others} />;
  }
}
